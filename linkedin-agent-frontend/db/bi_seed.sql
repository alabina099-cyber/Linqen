-- Données de test pour le Dashboard BI
-- Exécuter ce script dans Neon DB pour générer des données sur 60 jours
...
-- 3. Prospects (générés sur 60 jours avec différents statuts et scores)
...
-- Statut: identified (nouveaux prospects)
...
-- Prospects supplémentaires pour la densité géographique
...
-- 4. Messages (générés sur 60 jours avec différents statuts et horaires)
...
-- Messages convertis (replied puis converted)
...
-- Messages avec réponses (mais pas encore convertis)
...
-- Messages envoyés mais sans réponse
...
-- Messages récents (pour la heatmap horaire)
...
-- Messages avec horaires spécifiques pour la heatmap (mardi 10h, jeudi 14h, etc.)
(1, 20, 'Alexandre Lefebvre', 'VP Engineering', 'TechNova', 'Bonjour Alexandre, votre profil sur TechNova m''a intéressé...', 'connection', 'sent', NOW() - INTERVAL '1 day' - INTERVAL '8 hours'), -- mardi 10h
(2, 21, 'Isabelle Morel', 'Director of Tech', 'CloudNative', 'Bonjour Isabelle, votre profil sur CloudNative m''a intéressé...', 'connection', 'sent', NOW() - INTERVAL '1 day' - INTERVAL '6 hours'), -- mardi 12h
(3, 22, 'François Henry', 'CTO', 'ScaleTech', 'Bonjour François, votre profil sur ScaleTech m''a intéressé...', 'connection', 'sent', NOW() - INTERVAL '1 day' - INTERVAL '4 hours'), -- mardi 14h
(1, 23, 'Catherine Poulain', 'Engineering Manager', 'DevOpsPro', 'Bonjour Catherine, votre profil sur DevOpsPro m''a intéressé...', 'connection', 'sent', NOW() - INTERVAL '1 day' - INTERVAL '2 hours'), -- mardi 16h
(2, 24, 'David Lemoine', 'Tech Lead', 'DataMinds', 'Bonjour David, votre profil sur DataMinds m''a intéressé...', 'connection', 'sent', NOW() - INTERVAL '1 day' - INTERVAL '1 hour'), -- mardi 17h
-- Messages supplémentaires pour le volume
...
-- 5. Agent tool steps (pour l'agent analytics)
...
-- 6. LinkedIn actions queue (pour les approbations)
...
-- 7. Agent chat history (pour les conversations)
