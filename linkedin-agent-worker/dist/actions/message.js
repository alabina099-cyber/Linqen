 ...
 */
async function executeSendMessage(page, action) {
    ...
    try {
        ...
        for (const selector of chatInputSelectors) {
            const found = await (0, browser_1.safeWaitForSelector)(page, selector, 6000);
            if (found) {
                await page.click(selector);
                await (0, browser_1.sleep)(300);
