        ...
        <TabsContent value="account" className="space-y-6">
          ...
          <Card className="overflow-hidden border-0 shadow-lg">
            ...
            <CardHeader>
              ...
              <CardDescription>Connectez votre compte LinkedIn pour commencer la prospection</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  <p className="text-sm font-medium text-gray-700 mb-1">Statut du compte</p>
                  <Badge className="bg-green-100 text-green-700">Actif</Badge>
                  <p className="text-xs text-gray-500 mt-2">Votre compte est en bon état</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-xl">
                  <p className="text-sm font-medium text-gray-700 mb-1">Score de santé</p>
                  <div className="flex items-center gap-2">
                    <div className="flex-1 bg-gray-200 rounded-full h-2">
                      <div className="w-[92%] bg-green-500 rounded-full h-2" />
                    </div>
                    <span className="text-sm font-medium">92%</span>
                  </div>
                  <p className="text-xs text-gray-500 mt-2">Excellent - Risque de restriction faible</p>
                </div>
              </div>
            </CardContent>
          </Card>

          {/* Profile Info - Amélioré */}
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900">Photo de profil</p>
                  <p className="text-sm text-gray-500 mb-2">Cette photo sera visible dans vos messages et votre profil</p>
                  <div className="flex gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="account-company" className="block text-sm font-medium text-gray-700 mb-1">
                    Entreprise
                  </label>
                  <input
                    id="account-company"
          ...
          {/* Changement de mot de passe - Nouvelle section */}
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <Button variant="ghost" size="icon" className="absolute right-1 top-1/2 -translate-y-1/2 w-8 h-8 text-gray-400 hover:text-gray-600">
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg mt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Sécurisez votre compte avec 2FA</p>
                  </div>
                </div>
                <Badge className="bg-gray-100 text-gray-600">Désactivé</Badge>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
